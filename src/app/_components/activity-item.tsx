    ...
    <div className="border-border-light border-b py-4 last:border-b-0">
      <div className="mb-2 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="flex h-8 w-8 items-center justify-center rounded-full bg-primary-blue font-medium text-bg-light text-sm">
            {candidateInitials}
          </div>
      ...
      <p className="pl-11 text-sm text-text-secondary">
